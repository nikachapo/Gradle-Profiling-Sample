...
dependencies {
    ...
    implementation(project(":feature5"))
    implementation(project(":feature6"))
    implementation(project(":feature7"))
    implementation(project(":feature8"))
    implementation(project(":feature9"))
